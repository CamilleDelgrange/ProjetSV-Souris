...
// animal
, animal_time_between_rotations(sf::seconds(mConfig["simulation"]["animal"]["time between rotations"].toDouble()))
, animal_deceleration(mConfig["simulation"]["animal"]["deceleration"].toDouble())
...
, mouse_size(mConfig["simulation"]["animal"]["mouse"]["size"].toDouble())
	...
	, mouse_energy_limit(mConfig["simulation"]["animal"]["mouse"]["energy"] ["limit"].toDouble())
		// substance
